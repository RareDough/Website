<?php 
  include 'header.php';
  $itemData = file_get_contents('./assets/24.json');
          ...
          <div class="col-lg-12">
            <div class="description mt-5 mb-5 mt-lg-0 mb-lg-0">
              ...
              <div class="descriptionBody">
                ...
                <div class="row ">
                  <div class="col-lg-6 ">
                    <a id="mintButton" data-id="24" class="mainBtn light" data-price="<?= str_replace(' BREAD','',$itemPrice); ?>" href="#">Connect Wallet</a>
                  </div>
                  <div class="col-lg-6 ">
