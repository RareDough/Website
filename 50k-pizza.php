<?php 
  include 'header.php';
  $itemData = file_get_contents('./assets/10.json');
          ...
          <div class="col-lg-12">
            <div class="description mt-5 mb-5 mt-lg-0 mb-lg-0">
              ...
              <div class="descriptionBody">
                ...
                <div class="row ">
                  <div class="col-lg-6 ">
                    <a class="mainBtn light" href="https://opensea.io/assets/matic/0xf829fdf890b800d2be08bea228142726fed3e71d/10" target="_blank">Buy on Opensea</a>
                  </div>
                  <div class="col-lg-6 ">
